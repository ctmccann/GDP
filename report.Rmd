...
table(merged_Data$Income.Group, ApplyQuantiles)

# There are 16 countries that are lower middle income and among the 38 nations in the highest quantile group
```
<br>
